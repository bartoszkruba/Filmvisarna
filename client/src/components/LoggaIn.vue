<template>
  <section class="form">
    ...
    <b-modal v-model="modalShow" title="Medlemsvillkor" ok-only>
      ...
      SF Bio AB förbehåller sig rätten att efter egen bedömning avsluta medlemskapet om detta missbrukas eller för det fall Medlemmen vid besök på SF Bio AB:s biografer agerar i strid med SF Bio AB:s vid var tid gällande ordningsregler. Ett avslutande av medlemskapet kan innebära att intjänade poäng förverkas. SF Bio AB förbehåller sig också rätten att avsluta kundklubben Filmstaden, men ska då informera dig om detta minst sex (6) månader i förväg via e-post och övriga medlemskanaler.
      <br>
      <br>
      ...
      Medlemskapet får endast användas för icke-kommersiellt bruk. Du får inte sälja poäng och du får inte använda medlemskapet på ett sådant sätt att SF Bio AB eller annan drabbas av olägenhet eller skada. Du får inte bryta mot svensk lag och du måste följa SF Bio AB:s regler.
      <br>
      <br>
      ...
      På dina personliga sidor som du når via inloggning; ”Logga in” kan du se all information kring ditt medlemskap, och där kan du också hantera ditt medlemskap, se poäng och nivåer m.m. Du loggar in på Mina Sidor i Appen eller på sf.se med din mailadress.
      <br>
      <br>
